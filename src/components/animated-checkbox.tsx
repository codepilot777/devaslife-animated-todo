    ...
    <Svg viewBox={[-MARGIN, -MARGIN, vWidth + MARGIN, vHeight + MARGIN].join(' ')}>
      <Defs>
        <ClipPath id="clipPath">
          <Path fill="white" stroke="gray"
          strokeLinejoin="round"
          strokeLinecap="round"
          d={outlineBoxPath} />
        </ClipPath>
      </Defs>
      <AnimatedStroke progress={progress} d={checkMarkpath} stroke={highlightColor}
        strokeWidh={10}
        strokeLinejoin="round"
        strokeLinecap="round"
        strokeOpacity={checked || false ? 1: 0}/>
      <AnimatedPath d={outlineBoxPath} strokeWidth={7} strokeLinejoin="round" strokeLinecap="round" 
      animatedProps={animatedBoxProps}/>
      <Path d={outlineBoxPath} stroke="black" />
      <G clipPath="url(#clipPath)">
        <AnimatedStroke progress={progress} d={checkMarkpath} stroke={checkmarkColor}
        strokeWidh={10}
        strokeLinejoin="round"
        strokeLinecap="round"
        strokeOpacity={checked || false ? 1: 0}/>
